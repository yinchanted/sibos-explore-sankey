(function () {
    ...
    function filterData(sankey, data, minValue, maxValue) {
        sankey
            .nodes(data.nodes)
            .links(data.links)
            .layout(1);
    ...
    SankeyDiagram.prototype.draw = function (data, minLinkValue, maxLinkValue) {
        ...
        data = filterData(sankey, data, minLinkValue, maxLinkValue);
