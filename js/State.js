(function () {
    function State() {
        ...
        this.change = function (newValues) {
            ...
            if (isNumber(newValues.maxLinkValue) && currentState.maxLinkValue !== newValues.maxLinkValue) {
                currentState.maxLinkValue = newValues.maxLinkValue;

                change.maxLinkValue = true;
            }
            ...
            if (change.year || change.questions || change.minLinkValue || change.maxLinkValue || change.splitMultipleAnswers) {
